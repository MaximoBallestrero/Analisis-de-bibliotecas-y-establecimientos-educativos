...
nombre_archivo = 'padron_poblacion.xlsx'
dfHabitantes = guardar_datos_poblacion(nombre_archivo)
# Unificamos CABA
...
archivo_bibliotecas = 'bibliotecas-populares.csv'
...
nombre_colegios = '2022_padron_oficial_establecimientos_educativos.xlsx'
colegios = pd.read_excel(nombre_colegios)
...
consulta3.boxplot(by='Provincia', column='Cant_EE',ax=ax, grid=False, showmeans=True, meanprops=dict(marker='^', markersize=4, markerfacecolor='black'))
fig.suptitle('')
ax.set_title('Distribución de cantidad de Establecimientos Educativos por provincia')
...
ax.set_title('Relación entre cantidad de BP y EE cada 1000 habitantes por departamento',fontsize=11)
